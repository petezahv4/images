<html lang="en-us"><head>
    ...
    <script type="text/javascript" async="" src="https://server.cpmstar.com/cached/zonefiles/372_49986_1v1.js?rnd=537953"></script><script src="js/googleAnalytics.js"></script>
  ...
  <body>
    <div class="ads">
      <div class="ad-smallscreen">
        <div class="ad ad-rectangle-bottom" id="adRectangleBottom" style="display: block; transform: scale(0.909091);"></div>
      </div>
      <div class="ad ad-rectangle-upper" id="adRectangleUpper" style="display: block; transform: scale(0.909091);">
        ...
        </script><div style="width:300px;height:250px" class="g1lbg1ik"></div>
      </div>
      <div class="ad-largescreen">
        <div class="ad ad-leaderboard-bottom" style="display: block; transform: scale(0.909091);">
          ...
          </script><div style="width:300px;height:600px" class="r1lbhegb"></div>
        </div>
      </div>
    </div>

    <!-- <div id="interAdsContainer" style="display: none;"></div> -->
    <div id="gameContainer" style="padding: 0px; margin: 0px; border: 0px; position: relative; background: rgb(0, 0, 0);"><canvas id="#canvas" width="2400" height="1250" style="width: 100%; height: 100%; cursor: default;"></canvas></div>
